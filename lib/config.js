...
environment.staging = {
  ...
  'stripe_sourceToken' : 'A_USER_CREADIT_CARD',   // Replace wth valid data
  'stripe_apiKey' : 'Bearer A_UNIQUE_API_KEY',    // Replace wth valid data
  'mailGun_DomainName' : 'A_DOMAIN_NAME',         // Replace wth valid data
  'mailGun_apiKey' : 'A_UNIQUE_API_KEY'           // Replace wth valid data
};
